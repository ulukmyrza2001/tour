			...
			<div className={clsx('container', styles.footer__container)}>
				<div className={styles.footer__header}>
					<Link href='/' className={styles.footer__logo}>
						<Image
							fill
							src={'/img/logo-footer-second.svg'}
							alt='Логотип Тур Агентства Мещера'
						/>
						<Image
							width={245}
							height={50}
						...
						{isTablet ? (
							<div className={styles.footer__payments}>
								<a
									...
									className={clsx(
										styles.footer__link,
										styles.footer__link_mastercard,
									)}
								>
									<Image
								...
								<a
									...
									className={clsx(
										styles.footer__link,
										styles.footer__link_mir,
									)}
								>
									<Image
										src={'/icons/mir-card.svg'}
										width={125}
										height={40}
										alt='Логотип МИР кард'
									/>
								</a>
							</div>
						) : null}
					...
					<div className={styles.footer__content}>
						...
						<div className={styles.footer__meta}>
							<p className={styles.footer__text}>
								Мещера Тур - All rights reserved. Копирование
								материалов без указания обратной ссылки
								запрещено
							</p>
						</div>
						{!isTablet ? (
